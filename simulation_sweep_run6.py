...
def adjusted_utility(bank, bailout_probability, min_utility):
    max_utility = 100  # The maximum utility value
    ...
    # Define the point of maximum utility
    q_opt = 0.63
    
    # Now, if bailout_probability is greater than q_opt, it should start decreasing.
    # We'll use a simple linear decrease here, but you can choose any form you need.
    # Calculate the slope for the decreasing part after q_opt
    slope_decreasing = -steepness_decreasing / 0.2  # Example value, adjust as needed
        ...
        for time_step in range(num_timesteps):
            ...
            for network, adj_utilities in [(grid_network, adj_utilities_grid), 
                ...
                for node in network.nodes:
                    ...
                    adj_utility = adjusted_utility(bank, bailout_probability, min_utility=-400)  # replace -100 with your actual min_utility
